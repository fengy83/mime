mimemap = c(
  ...
  A2L = "application/A2L",
  ace-groupcomm+cbor = "application/ace-groupcomm+cbor",
  ...
  cfw = "application/cfw",
  cid-edhoc+cbor-seq = "application/cid-edhoc+cbor-seq",
  ...
  edhoc+cbor-seq = "application/edhoc+cbor-seq",
  ...
  geoxacml+json = "application/geoxacml+json",
  geoxacml+xml = "application/geoxacml+xml",
  gltf-buffer = "application/gltf-buffer",
  gml+xml = "application/gml+xml",
  gnap-binding-jws = "application/gnap-binding-jws",
  gnap-binding-jwsd = "application/gnap-binding-jwsd",
  gnap-binding-rotation-jws = "application/gnap-binding-rotation-jws",
  gnap-binding-rotation-jwsd = "application/gnap-binding-rotation-jwsd",
  ...
  jscontact+json = "application/jscontact+json",
  ...
  private-token-issuer-directory = "application/private-token-issuer-directory",
  private-token-request = "application/private-token-request",
  private-token-response = "application/private-token-response",
  ...
  prs.vcfbzip2 = "application/prs.vcfbzip2",
  ...
  rpki-signed-tal = "application/rpki-signed-tal",
  ...
  ST2110-41 = "application/ST2110-41",
  ...
  vnd.3gpp.5gsa2x = "application/vnd.3gpp.5gsa2x",
  vnd.3gpp.5gsa2x-local-service-information = "application/vnd.3gpp.5gsa2x-local-service-information",
  ...
  vnd.3gpp.pinapp-info+xml = "application/vnd.3gpp.pinapp-info+xml",
  ...
  vnd.acm.chatbot+json = "application/vnd.acm.chatbot+json",
  ...
  vnd.bzip3 = "application/vnd.bzip3",
  vnd.c3voc.schedule+xml = "application/vnd.c3voc.schedule+xml",
  ...
  vnd.freelog.comic = "application/vnd.freelog.comic",
  ...
  vnd.ga4gh.passport+jwt = "application/vnd.ga4gh.passport+jwt",
  ...
  vnd.ldev.productlicensing = "application/vnd.ldev.productlicensing",
  ...
  vnd.msgpack = "application/vnd.msgpack",
  ...
  vnd.nato.bindingdataobject+cbor = "application/vnd.nato.bindingdataobject+cbor",
  vnd.nato.bindingdataobject+json = "application/vnd.nato.bindingdataobject+json",
  vnd.nato.bindingdataobject+xml = "application/vnd.nato.bindingdataobject+xml",
  vnd.nato.openxmlformats-package.iepd+zip = "application/vnd.nato.openxmlformats-package.iepd+zip",
  ...
  vnd.oai.workflows = "application/vnd.oai.workflows",
  vnd.oai.workflows+json = "application/vnd.oai.workflows+json",
  vnd.oai.workflows+yaml = "application/vnd.oai.workflows+yaml",
  ...
  vnd.relpipe = "application/vnd.relpipe",
